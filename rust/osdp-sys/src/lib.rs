...
extern "C" {
    pub fn osdp_frame_decode(
        buf: *const u8,
        len: usize,
        out: *mut osdp_frame_t,
    ) -> osdp_status_t;
...
extern "C" {
    ...
    pub fn osdp_stream_feed(
        s: *mut osdp_stream_t,
        data: *const u8,
        len: usize,
    ) -> osdp_status_t;
    pub fn osdp_stream_next(
        s: *mut osdp_stream_t,
        out: *mut osdp_frame_t,
    ) -> osdp_status_t;
}
...
#[repr(C)]
pub struct osdp_id_cmd_t { pub id_type: u8 }

#[repr(C)]
pub struct osdp_cap_cmd_t { pub reply_type: u8 }
...
extern "C" {
    ...
    pub fn osdp_id_decode(payload: *const u8, len: usize, out: *mut osdp_id_cmd_t) -> osdp_status_t;
    pub fn osdp_id_build (in_: *const osdp_id_cmd_t, buf: *mut u8, buf_cap: usize, written: *mut usize) -> osdp_status_t;

    pub fn osdp_cap_decode(payload: *const u8, len: usize, out: *mut osdp_cap_cmd_t) -> osdp_status_t;
    pub fn osdp_cap_build (in_: *const osdp_cap_cmd_t, buf: *mut u8, buf_cap: usize, written: *mut usize) -> osdp_status_t;

    pub fn osdp_out_decode(
        payload: *const u8, len: usize,
        records: *mut osdp_out_record_t, records_cap: usize,
        records_written: *mut usize,
    ) -> osdp_status_t;
    pub fn osdp_out_build(
        records: *const osdp_out_record_t, record_count: usize,
        buf: *mut u8, buf_cap: usize, written: *mut usize,
    ) -> osdp_status_t;

    pub fn osdp_led_decode(
        payload: *const u8, len: usize,
        records: *mut osdp_led_record_t, records_cap: usize,
        records_written: *mut usize,
    ) -> osdp_status_t;
    pub fn osdp_led_build(
        records: *const osdp_led_record_t, record_count: usize,
        buf: *mut u8, buf_cap: usize, written: *mut usize,
    ) -> osdp_status_t;

    pub fn osdp_buz_decode(payload: *const u8, len: usize, out: *mut osdp_buz_cmd_t) -> osdp_status_t;
    pub fn osdp_buz_build (in_: *const osdp_buz_cmd_t, buf: *mut u8, buf_cap: usize, written: *mut usize) -> osdp_status_t;

    pub fn osdp_text_decode(payload: *const u8, len: usize, out: *mut osdp_text_cmd_t) -> osdp_status_t;
    pub fn osdp_text_build (in_: *const osdp_text_cmd_t, buf: *mut u8, buf_cap: usize, written: *mut usize) -> osdp_status_t;

    pub fn osdp_comset_decode(payload: *const u8, len: usize, out: *mut osdp_comset_cmd_t) -> osdp_status_t;
    pub fn osdp_comset_build (in_: *const osdp_comset_cmd_t, buf: *mut u8, buf_cap: usize, written: *mut usize) -> osdp_status_t;
}
...
extern "C" {
    ...
    pub fn osdp_nak_build (in_: *const osdp_nak_t, buf: *mut u8, buf_cap: usize, written: *mut usize) -> osdp_status_t;

    pub fn osdp_pdid_decode(payload: *const u8, len: usize, out: *mut osdp_pdid_t) -> osdp_status_t;
    pub fn osdp_pdid_build (in_: *const osdp_pdid_t, buf: *mut u8, buf_cap: usize, written: *mut usize) -> osdp_status_t;

    pub fn osdp_pdcap_decode(
        payload: *const u8, len: usize,
        records: *mut osdp_pdcap_record_t, records_cap: usize,
        records_written: *mut usize,
    ) -> osdp_status_t;
    pub fn osdp_pdcap_build(
        records: *const osdp_pdcap_record_t, record_count: usize,
        buf: *mut u8, buf_cap: usize, written: *mut usize,
    ) -> osdp_status_t;

    pub fn osdp_raw_decode(payload: *const u8, len: usize, out: *mut osdp_raw_t) -> osdp_status_t;
    pub fn osdp_raw_build (in_: *const osdp_raw_t, buf: *mut u8, buf_cap: usize, written: *mut usize) -> osdp_status_t;

    pub fn osdp_keypad_decode(payload: *const u8, len: usize, out: *mut osdp_keypad_t) -> osdp_status_t;
    pub fn osdp_keypad_build (in_: *const osdp_keypad_t, buf: *mut u8, buf_cap: usize, written: *mut usize) -> osdp_status_t;

    pub fn osdp_com_decode(payload: *const u8, len: usize, out: *mut osdp_com_t) -> osdp_status_t;
    pub fn osdp_com_build (in_: *const osdp_com_t, buf: *mut u8, buf_cap: usize, written: *mut usize) -> osdp_status_t;
}
...
pub type osdp_sc_rand_cb = Option<
    unsafe extern "C" fn(user: *mut c_void, out: *mut u8, len: usize) -> osdp_status_t,
>;
...
extern "C" {
    ...
    pub fn osdp_sc_client_cryptogram(
        crypto: *const osdp_sc_crypto_t,
        s_enc: *const u8,  rnd_a: *const u8,  rnd_b: *const u8,
    ...
    pub fn osdp_sc_initial_rmac(
        crypto: *const osdp_sc_crypto_t,
        s_mac1: *const u8, s_mac2: *const u8,
    ...
    pub fn osdp_sc_encrypt_payload(
        ...
        ciphertext: *mut u8, ciphertext_cap: usize,
    ...
    pub fn osdp_sc_decrypt_payload(
        ...
        plaintext: *mut u8, plaintext_cap: usize,
    ...
    pub fn osdp_sc_unwrap_frame(
        ...
        plaintext_out: *mut u8, plain_cap: usize,
        plain_len: *mut usize,
    ) -> osdp_status_t;
}
...
pub type osdp_pd_read_cb   = Option<unsafe extern "C" fn(user: *mut c_void, buf: *mut u8, cap: usize) -> c_int>;
pub type osdp_pd_write_cb  = Option<unsafe extern "C" fn(user: *mut c_void, buf: *const u8, len: usize) -> c_int>;
...
extern "C" {
    ...
    pub fn osdp_pd_set_command_handler(pd: *mut osdp_pd_t, cb: osdp_pd_command_cb, user: *mut c_void);
...
pub type osdp_acu_reply_cb   = Option<unsafe extern "C" fn(user: *mut c_void, event: *const osdp_acu_reply_event_t)>;
pub type osdp_acu_timeout_cb = Option<unsafe extern "C" fn(user: *mut c_void, event: *const osdp_acu_timeout_event_t)>;
...
extern "C" {
    ...
    pub fn osdp_acu_set_reply_handler  (acu: *mut osdp_acu_t, cb: osdp_acu_reply_cb,   user: *mut c_void);
    pub fn osdp_acu_set_timeout_handler(acu: *mut osdp_acu_t, cb: osdp_acu_timeout_cb, user: *mut c_void);
    ...
    pub fn osdp_acu_set_pd_scbk  (acu: *mut osdp_acu_t, pd_address: u8, scbk:   *const u8) -> osdp_status_t;
    pub fn osdp_acu_set_pd_scbk_d(acu: *mut osdp_acu_t, pd_address: u8, scbk_d: *const u8) -> osdp_status_t;
    pub fn osdp_acu_set_sc_event_handler(acu: *mut osdp_acu_t, cb: osdp_acu_sc_event_cb, user: *mut c_void);
