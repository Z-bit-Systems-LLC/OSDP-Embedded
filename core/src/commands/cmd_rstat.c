...
/* osdp_RSTAT (0x67) — spec 6.8, Table 12.
 *
 * Request for a reader status report. DATA is omitted, so the codec is purely a
 * length assertion on decode and a no-op on build; the interesting half of
 * this exchange is the reply, osdp_RSTATR (7.9). */
