...
#ifndef OSDP_PD_MOCK_SC2_ADAPTER_H
#define OSDP_PD_MOCK_SC2_ADAPTER_H

/* Wraps the shared vendored AES-256-GCM (vendor/tiny-gcm), AES-256 block
 * (vendor/tiny-aes256), and KMAC256 (vendor/tiny-kmac) as an
 * osdp_sc2_crypto_t so the PD's Secure Channel 2 state machine has the
 ...
 * CSPRNG. pd_mock_sc2_seed_rand(seed) makes RND.B deterministic for
...
#endif /* OSDP_PD_MOCK_SC2_ADAPTER_H */
